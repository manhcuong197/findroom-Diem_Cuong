						...
						<form id="formSubmit">
							<div class="form-group">
								...
								<div class="col-sm-9">
									...
									<c:if test="${empty room.userNameRoom}">
										<input type="text" class="form-control"  id="userNameRoom"
											name="userNameRoom" value="${room.userNameRoom}">
									</c:if>
									<c:if test="${not empty room.userNameRoom}">
										<input type="text" class="form-control" name="userNameRoom" id="userNameRoom"
											 value="${room.userNameRoom}">
								...
								<div class="col-sm-9">
									<select class="form-control" id="typeRoom" name="typeRoom">
										...
										<c:if test="${not empty room.typeRoom}">
											<option>Loại phòng</option>
											<c:forEach var="type1" items="${type}">
												<option value="${type1.type_room}"
													<c:if test="${type1.type_room == room.typeRoom}">selected="selected"</c:if>>
													${type1.type_room}</option>
											</c:forEach>
										</c:if>
									</select>
								...
								<div class="col-sm-9">
									<select class="form-control" id="typeRoom" name="numberRoom">
										...
										<c:if test="${not empty room.numberRoom}">
											...
											<c:forEach var="add" items="${address}">
												<option value="${add.number}"
													<c:if test="${add.number == room.numberRoom}">selected="selected"</c:if>>
													${add.number}</option>
											</c:forEach>
										</c:if>
									</select>
								...
								<div class="col-sm-9">
									<select class="form-control" id="streetRoom" name="streetRoom">
										...
										<c:if test="${not empty room.streetRoom}">
											...
											<c:forEach var="add" items="${address}">
												<option value="${add.street}"
													<c:if test="${add.street == room.streetRoom}">selected="selected"</c:if>>
													${add.street}</option>
											</c:forEach>
										</c:if>
									</select>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<select class="form-control" id="districtRoom"
										name="districtRoom">
										...
										<c:if test="${not empty room.districtRoom}">
											...
											<c:forEach var="add" items="${address}">
												<option value="${add.district}"
													<c:if test="${add.street == room.districtRoom}">selected="selected"</c:if>>
													${add.district}</option>
											</c:forEach>
										</c:if>
									</select>
									...
									<select class="form-control" id="cityRoom" name="cityRoom">
										...
										<c:if test="${not empty room.cityRoom}">
											...
											<c:forEach var="add" items="${address}">
												...
												<option value="${add.city}"
													<c:if test="${add.city == room.cityRoom}">selected="selected"</c:if>>
													${add.city}</option>
											</c:forEach>
										</c:if>
									</select>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" id="electricity"
										name="electricity" value="${room.electricity}">
								</div>
							</div>
							<br /> <br />
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" id="post_time"
										name="post_time" value="${room.post_time}">
								</div>
							</div>
							<br /> <br />
							<div class="form-group">
								<div class="col-sm-12">
									...
									<c:if test="${empty room.id}">
										<input type="submit"
											class="btn btn-white btn-warning btn-bold" value="Thêm Phòng"
